...
\title{Máquina de Turing: Algoritmo} 
...
\section{Avisos}
	\begin{frame}{Avisos}			
		\begin{exampleblock}{Teste 03}
			Dia {\bf 28 de maio} (Quarta-feira)!!!
		\end{exampleblock}
	\end{frame}
	...
	\begin{frame}{Enumeradores}
		\begin{block}{Características}
			\begin{itemize}
				\item A MT pode utilizar a impressora como dispositivo de saída;
				\item O enumerador $E$ inicia com uma fita de entrada em branco;
				\item A linguagem enumerada por $E$ é a coleção de todas as cadeias que $E$ em algum momento imprime;
				\item $E$ pode imprimir as cadeias da linguagem em qualquer ordem, possivelmente com repetições.
			\end{itemize}
		\end{block}
	\end{frame}
	...
	\begin{block}{Teorema}
		...
		\end{block}
		\begin{center}
			\includegraphics[height=2cm]{images/provaTeo321-1}\\
			\includegraphics[height=2.3cm]{images/provaTeo321-2}
		\end{center}
	\end{frame}
	
	\section{Variantes de MT (Cont.)}

...
\begin{document}
	...
	\begin{frame}{Informações Importantes}
		\begin{block}{Disciplina}
			\begin{itemize}
				...
				\item 09h30-11h10 (Segunda, LEC I)\\
	...
	\begin{frame}{Informações Importantes}
		\begin{block}{Testes}
			\begin{itemize}
				\item Primeiro teste equivale a 20\% da pontuação total;
				\item Segundo teste equivale a 20\% da pontuação total;
				\item Terceiro teste equivale a 20\% da pontuação total;
				\item Quarto teste equivale a 20\% da pontuação total.
			\end{itemize}
		\end{block}
		\begin{block}{Avaliação}
			\begin{itemize}
				\item Prova equivale a 20\% da pontuação total.
			\end{itemize}
		\end{block}
		\begin{block}{Exercícios [Bônus]}
			\begin{itemize}
				\item Somatório de todos os exercícios equivale a \\10\% da pontuação total.
			\end{itemize}
		\end{block}
	\end{frame}

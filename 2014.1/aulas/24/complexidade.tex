	...
	\begin{frame}{Pensamento}
		\begin{columns}
			...
			\column{.6\textwidth}  		
				\begin{block}{Frase}
					\begin{center}
						{\large É necessário cuidar da ética para não anestesiarmos a nossa consciência e começarmos a achar que \\tudo é normal.}
					\end{center}
				\end{block}		  		
		  		\begin{block}{Quem?}
		  			\begin{center}
						{\bf Mário Sérgio Cortella (1954 - ***)} \\Educador e filósofo brasileiro.
					\end{center}
				\end{block}
		\end{columns}
	\end{frame}
